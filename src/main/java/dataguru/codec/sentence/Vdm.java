...
public class Vdm extends EncapsulatedSentence {
    ...
    /**
     * check the format of the sentenceline
     *
     * @param sl
     * @return boolean
     * @throws SentenceException
     */
    public boolean preEncodeProcess(SentenceLine sl)throws SentenceException{
        // Do common parsing
        super.baseParse(sl);
...
//            throw new SentenceException("Sentence does not have at least 8 fields");
     ...
     */
    @Override
    public int doParse(SentenceLine sl) throws SentenceException {
